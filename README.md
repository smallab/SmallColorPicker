...
Please note that the USColorPicker classes are provided as used in apps *optimized for the iPhone 5* such as [Pixel is Data](https://pixelisdata.org). Some adaptation might (will) be necessary. The Smallab Collective can in no way be held responsible for their malfunction or misuse in your own project.
